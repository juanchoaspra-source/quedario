...
export function publicGroup(group, token) {
  return { name: group.name, city: group.city || '', slug: group.slug, platform: group.platform || 'whatsapp', owner: isAdmin(group, token), protected: !!group.password, closed: !!group.closed,
